...
* 10 хостов, совершивших максимальное число запросов (отсортировать в обратном порядке по кол-ву совершенных запросов), и информацию по ним:
...
* общее кол-во запросов по каждому статусу (отсортировать их по коду статуса)
