...
* transferred - кол-во реально переданных данных (после расжатия; в целых килобайтах) для ответов со статусом 200
* transferred_<STATUS> (например, transferred_200) - кол-во сжатых данных по каждому статусу, в целых килобайтах (колонки должны следовать в порядке возрастания кода статуса)
...
```perl
IP	count	avg	transfered	transfered_200	transfered_301	transfered_302	transfered_400	transfered_403	transfered_404	transfered_408	transfered_414	transfered_499	transfered_500
