...
mod_perl - это надстройка над CGI для единовременной компиляции скриптов
...
Создать WEB-приложение с 2 разделами, публичным и приватным. 
- Публичный раздел:
  - страница регистрации
  - страница авторизации
  - страница, отображающая аватарки последних 5 зарегистрированных пользователей. 
- Приватный раздел:
  - страница редактирования личных данных (аватарка (ссылка из интернета), пароль, ник)
  - страница удаления пользователя
  - страница просмотрa всей информации по пользователю (ник, аватарка)

В приложении должна использоваться любая SQL база данных.
