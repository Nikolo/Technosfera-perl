use utf8;
package Local::Metric::Schema::Result::Measure;
...
Related object: L<Local::Metric::Schema::Result::Metric>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:I36new2BiIQaWS6NgKI1AQ
